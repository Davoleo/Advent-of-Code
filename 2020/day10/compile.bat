...
:: compiles the java source into .class files
javac Day10.java

:: runs the class file containing the main method
java Day10
...
You glance back down at your bag and try to remember why you brought so many adapters; there must be more than a trillion valid ways to
arrange them! Surely, there must be an efficient way to count the arrangements.
